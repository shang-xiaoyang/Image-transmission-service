 ...
 * @private unstable method
 */
export declare function bindAcceleratorWithMultiRegionAccessPoint(this: TOSBase, input: BindAcceleratorWithMultiRegionAccessPointInput): Promise<import("../base").TosResponse<BindAcceleratorWithMultiRegionAccessPointOutput>>;
 ...
 * @private unstable method
 */
export declare function unbindAcceleratorWithMultiRegionAccessPoint(this: TOSBase, input: UnbindAcceleratorWithMultiRegionAccessPointInput): Promise<import("../base").TosResponse<UnbindAcceleratorWithMultiRegionAccessPointOutput>>;
 ...
 * @private unstable method
 */
export declare function listBindAccessPointForMultiRegionAccelerator(this: TOSBase, input: ListBindAccessPointForMultiRegionAcceleratorInput): Promise<import("../base").TosResponse<ListBindAccessPointForMultiRegionAcceleratorOutput>>;
